 ...
 *
 */
package de.hybris.platform.addon.subscriptionstorefront.hmc;
...
/**
 * Provides necessary meta information about the subscriptionstorefront hmc extension.
 * 
 * 
 * @version ExtGen v5.7.0.31
 */
public class SubscriptionstorefrontHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(SubscriptionstorefrontHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "de.hybris.platform.addon.subscriptionstorefront.hmc.locales";
